          ...
          >
            ...
            <div className="flex gap-3 mb-6">
              <motion.button 
                ...
                disabled={isLoading}
                className="flex-1 flex items-center justify-center gap-2 py-3 px-4 backdrop-blur-xl bg-white/5 border border-white/10 hover:border-white/30 rounded-lg text-white text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                whileHover={!isLoading ? { scale: 1.02 } : {}}
                whileTap={!isLoading ? { scale: 0.98 } : {}}
              >
